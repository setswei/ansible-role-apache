...
[![Build Status](https://travis-ci.org/setswei/ansible-role-apache.svg?branch=master)](https://travis-ci.org/setswei/ansible-role-apache) ![Build Status](http://bamboo.cybercrysis.net.au/plugins/servlet/wittified/build-status/SVR-ANAP)
